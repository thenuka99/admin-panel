...
function Cloud(props) {
    var _a;
    var className = props.className, layerWidth = props.layerWidth, layerHeight = props.layerHeight, _b = props.colors, colors = _b === void 0 ? colorFunc.defaultSchemeName : _b;
    ...
    React.useEffect(function () {
        ...
        var words = (series === null || series === void 0 ? void 0 : series.reduce(function (words, _a, seriesIndex) {
            ...
            data.forEach(function (point, pointIndex) {
                words.push(tslib_es6.__assign(tslib_es6.__assign({}, point), { text: point.label, size: point.y, seriesIndex: seriesIndex, pointIndex: pointIndex }));
            });
            return words;
        }, [])) || [];
        var cl = cloud__default['default']()
        ...
        if (!isUndefined.isUndefined(rotate)) {
            cl.rotate(rotate);
        }
        if (random) {
            cl.random(random);
    ...
    return React__default['default'].createElement("g", { className: className, style: props.style, opacity: props.opacity, transform: 'translate(' + (layerWidth / 2) + ',' + (layerHeight / 2) + ')' }, (_a = state.series) === null || _a === void 0 ? void 0 : _a.map(function (series, seriesIndex) {
        if ('seriesVisible' in props) {
            var seriesVisible = value.value(props.seriesVisible, { seriesIndex: seriesIndex, series: series, props: props });
            if (!seriesVisible) {
                return;
            }
        }
        var seriesAttributes = value.value(props.seriesAttributes, { seriesIndex: seriesIndex, series: series, props: props });
        var seriesStyle = value.value(props.seriesStyle, { seriesIndex: seriesIndex, series: series, props: props });
        return React__default['default'].createElement("g", tslib_es6.__assign({ key: seriesIndex, className: className && (className + '-series ' + className + '-series-' + seriesIndex), style: seriesStyle, opacity: series.opacity }, seriesAttributes), series.data.map(function (point, pointIndex) {
            var _a, _b;
            ...
            if ('labelVisible' in props) {
                var labelVisible = value.value(props.labelVisible, {
            ...
            var labelAttributes = value.value(props.labelAttributes, {
                seriesIndex: seriesIndex,
                pointIndex: pointIndex,
                point: point,
                label: label,
            ...
            var labelStyle = value.value([point.style, series.style, props.labelStyle], { seriesIndex: seriesIndex, pointIndex: pointIndex, point: point, label: label, series: series, props: props });
            return React__default['default'].createElement("g", { key: pointIndex, className: className && (className + '-label ' + className + '-label-' + +pointIndex), style: {
                ...
                React__default['default'].createElement("text", tslib_es6.__assign({ transform: 'translate(' + label.x + ',' + label.y + '),rotate(' + label.rotate + ')', fill: point.color || series.color || color(seriesIndex), fillOpacity: point.opacity, textAnchor: 'middle', style: labelStyle }, labelAttributes), label.text));
        }));
    }));
}
